...
int main(int argc, char *argv[])
{
	...
	if (service) {
		...
		/* This is the most sad part, IOMFBBrightnessLevel is a NSNumber, which not compatible with C, we then have to -xobjective-c -fobjc-arc */
		...
		/* This is the most fkin confusing part, While source file has suffix .m, carets no longer considered as math power calculation,
		 * no warnings will be generated by compiler. (2 ^ 16) will become something like (2 ^{} 16) */
		printf("%.2f\n", (double)(int)cur * pow(2, -16));
	}
	/* DFR Brightness */
	else {
